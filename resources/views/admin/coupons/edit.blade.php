        ...
        <div class="col-md-12 col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="form form-horizontal" action="{{ route('admin.coupons.update', $coupon) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-body">
                                <div class="row">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <div class="input-group">
                                                            <input type="text" id="code" class="form-control @error('code') is-invalid @enderror"
                                                                name="code" value="{{ old('code', $coupon->code) }}" placeholder="Enter coupon code">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="text" id="name" class="form-control @error('name') is-invalid @enderror"
                                                            name="name" value="{{ old('name', $coupon->name) }}" placeholder="Enter coupon name">
                                                        @error('name')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <textarea id="description" class="form-control @error('description') is-invalid @enderror"
                                                            name="description" rows="3" placeholder="Enter coupon description">{{ old('description', $coupon->description) }}</textarea>
                                                        @error('description')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <div class="input-group">
                                                            <span class="input-group-text" id="value-label">{{ $coupon->type == 'percentage' ? '%' : 'Rp' }}</span>
                                                            <input type="text" id="value" class="form-control @error('value') is-invalid @enderror"
                                                                name="value" value="{{ old('value', $coupon->value) }}" placeholder="Enter coupon value">
                                                        </div>
                                                        @error('value')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="min_purchase" class="form-control @error('min_purchase') is-invalid @enderror"
                                                                name="min_purchase" value="{{ old('min_purchase', $coupon->min_purchase) }}" placeholder="Enter minimum purchase amount">
                                                        </div>
                                                ...
                                                <div class="row mb-3" id="max-discount-container" style="{{ $coupon->type != 'percentage' ? 'display: none;' : '' }}">
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" id="max_discount" class="form-control @error('max_discount') is-invalid @enderror"
                                                                name="max_discount" value="{{ old('max_discount', $coupon->max_discount) }}" placeholder="Enter maximum discount amount">
                                                        </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="number" id="max_uses" class="form-control @error('max_uses') is-invalid @enderror"
                                                            name="max_uses" value="{{ old('max_uses', $coupon->max_uses) }}" placeholder="Enter maximum number of uses">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="number" id="max_uses_per_user" class="form-control @error('max_uses_per_user') is-invalid @enderror"
                                                            name="max_uses_per_user" value="{{ old('max_uses_per_user', $coupon->max_uses_per_user) }}" placeholder="Enter maximum uses per user">
                                                        <small class="text-muted">Leave empty for unlimited</small>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="text" id="starts_at" class="form-control flatpickr-date @error('starts_at') is-invalid @enderror"
                                                            name="starts_at" value="{{ old('starts_at', $coupon->starts_at ? $coupon->starts_at->format('Y-m-d') : '') }}" placeholder="YYYY-MM-DD (e.g., 2025-03-04)">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="text" id="expires_at" class="form-control flatpickr-date @error('expires_at') is-invalid @enderror"
                                                            name="expires_at" value="{{ old('expires_at', $coupon->expires_at ? $coupon->expires_at->format('Y-m-d') : '') }}" placeholder="YYYY-MM-DD (e.g., 2025-03-04)">
                                                            ...
                                                            @foreach($categories as $category)
                                                                <option value="{{ $category->id }}"
                                                                    {{ (is_array(old('categories')) && in_array($category->id, old('categories'))) ||
                                                                        (old('categories') === null && $coupon->categories->contains($category->id)) ? 'selected' : '' }}>
                                                                    {{ $category->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                            ...
                                                            @foreach($products as $product)
                                                                <option value="{{ $product->id }}"
                                                                    {{ (is_array(old('products')) && in_array($product->id, old('products'))) ||
                                                                        (old('products') === null && $coupon->products->contains($product->id)) ? 'selected' : '' }}>
                                                                    {{ $product->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
