        ...
        <div class="col-md-12 col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Create New Address</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form class="form form-horizontal" action="{{ route('admin.addresses.store') }}" method="POST">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="text" id="recipient_name" class="form-control @error('recipient_name') is-invalid @enderror"
                                            name="recipient_name" value="{{ old('recipient_name') }}" placeholder="Enter recipient name">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="text" id="province" class="form-control @error('province') is-invalid @enderror"
                                            name="province" value="{{ old('province') }}" placeholder="Enter province">
                                        @error('province')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-8 form-group">
                                        <textarea id="address_detail" class="form-control @error('address_detail') is-invalid @enderror"
                                            name="address_detail" rows="3" placeholder="Enter address detail">{{ old('address_detail') }}</textarea>
