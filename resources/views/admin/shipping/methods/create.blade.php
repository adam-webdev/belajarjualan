        ...
        <div class="col-md-12 col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="form form-horizontal" action="{{ route('admin.shipping.methods.store') }}" method="POST">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="text" id="name" class="form-control @error('name') is-invalid @enderror"
                                            name="name" value="{{ old('name') }}" placeholder="Enter shipping method name">
                                        @error('name')
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="text" id="code" class="form-control @error('code') is-invalid @enderror"
                                            name="code" value="{{ old('code') }}" placeholder="Enter shipping method code">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control @error('default_cost') is-invalid @enderror" id="default_cost" name="default_cost" value="{{ old('default_cost', 0) }}" min="0" step="0.01">
                                        </div>
                                        @error('default_cost')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
