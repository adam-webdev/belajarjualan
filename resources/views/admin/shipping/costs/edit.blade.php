        ...
        <div class="col-md-12 col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Edit Shipping Cost</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form class="form form-horizontal" action="{{ route('admin.shipping.costs.update', $cost) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <select class="choices form-select @error('shipping_method_id') is-invalid @enderror" name="shipping_method_id">
                                            ...
                                            @foreach($shippingMethods as $method)
                                                <option value="{{ $method->id }}" {{ old('shipping_method_id', $cost->shipping_method_id) == $method->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="text" id="province" class="form-control @error('province') is-invalid @enderror"
                                            name="province" value="{{ old('province', $cost->province) }}" placeholder="Enter province name">
                                        @error('province')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="text" id="city" class="form-control @error('city') is-invalid @enderror"
                                            name="city" value="{{ old('city', $cost->city) }}" placeholder="Enter city name">
                                        @error('city')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-8 form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="cost" class="form-control @error('cost') is-invalid @enderror"
                                                name="cost" value="{{ old('cost', $cost->cost) }}" placeholder="Enter shipping cost">
                                        </div>
                                        @error('cost')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
