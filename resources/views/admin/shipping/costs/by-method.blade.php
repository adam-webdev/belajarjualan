...
@section('title')
    Shipping Costs for {{ $method->name }}
@endsection
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Shipping Costs for {{ $method->name }}</h4>
                <div class="d-flex justify-content-end">
                    <a href="{{ route('admin.shipping.methods.show', $method) }}" class="btn btn-secondary me-1">
                        <i class="bi bi-arrow-left"></i> Back to Method
                    </a>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0" id="table1">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="5" class="text-center">No shipping costs found for this method</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
