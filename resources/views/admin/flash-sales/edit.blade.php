        ...
        <div class="col-md-12 col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="form form-horizontal" action="{{ route('admin.flash-sales.update', $flashSale) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-body">
                                <div class="row">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-9 form-group">
                                                        <input type="text" id="name" class="form-control @error('name') is-invalid @enderror"
                                                            name="name" value="{{ old('name', $flashSale->name) }}" placeholder="Enter flash sale name">
                                                        @error('name')
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-9 form-group">
                                                        <textarea id="description" class="form-control @error('description') is-invalid @enderror"
                                                            name="description" rows="3" placeholder="Enter flash sale description">{{ old('description', $flashSale->description) }}</textarea>
                                                        @error('description')
                                                            <div class="invalid-feedback">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-9 form-group">
                                                        <input type="text" id="start_time" class="form-control flatpickr-datetime @error('start_time') is-invalid @enderror"
                                                            name="start_time" value="{{ old('start_time', $flashSale->start_time->format('Y-m-d H:i')) }}" placeholder="YYYY-MM-DD HH:MM (e.g., 2025-03-04 08:00)">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-9 form-group">
                                                        <input type="text" id="end_time" class="form-control flatpickr-datetime @error('end_time') is-invalid @enderror"
                                                            name="end_time" value="{{ old('end_time', $flashSale->end_time->format('Y-m-d H:i')) }}" placeholder="YYYY-MM-DD HH:MM (e.g., 2025-03-04 20:00)">
                                    ...
                                    <div class="col-sm-12 d-flex justify-content-end mt-3">
                                        <button type="submit" class="btn btn-primary me-1 mb-1">Update Flash Sale</button>
